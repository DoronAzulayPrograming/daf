 ...
 *
 * @daf-param For string required - model field path used for binding and validation (dot notation)
 ...
 */
abstract class InputBaseComponent extends Component
{
    public string $For;
    public bool $Feedback;
    public bool $InvalidClass;
    
    protected string $htmlName;
    protected FormContext $formContext;

    public function OnLoad(): void {
        $this->For = (string)$this->RequiredParameter("For");
        $this->Feedback = $this->Parameter("Feedback") ?? true;
        $this->InvalidClass = $this->Parameter("InvalidClass") ?? true;
