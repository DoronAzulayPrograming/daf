...
/**
 * @daf-summary Renders an email input (<code>type=email</code>) with model binding and validation feedback support.
 *
 ...
 */
class EmailInputComponent extends InputComponent
{
