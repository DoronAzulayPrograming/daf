...
{
    // Model instance used for binding values and validation metadata.
    public mixed $Model;

    // Enables client-side validation and JS submit interception
    public bool $ClientSideValidation = false;
