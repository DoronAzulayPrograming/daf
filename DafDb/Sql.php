...
class Sql
{
   static function CreateTable(string $table, array $fields): string
   {
      $primaryKeys = [];
   ...
   static function Insert(string $table, array $data): array
   {
   ...
   static function Update(string $table, array $data): array{
     ...
     */
   static function Where(callable $func, array $externals = []): array
   {
      return WhereParser::Parse($func, null, $externals);
   }

   // static function WhereOld(callable $func)
   // {
